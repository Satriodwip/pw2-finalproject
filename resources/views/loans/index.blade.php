    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="flex flex-col gap-10">
            ...
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                <!-- Table Headers -->
                <div class="grid grid-cols-12 border-t border-stroke px-2 py-3 dark:border-strokedark md:px-2 2xl:px-2">
                ...
                <div class="grid grid-cols-12 border-t border-stroke px-2 py-3 dark:border-strokedark md:px-2 2xl:px-2">
                    ...
                    <div class="col-span-1 flex items-center md:px-7 2xl:px-7.5">
                        <div class="flex flex-col gap-4 sm:flex-row sm:items-center">
                            ...
                            @else
                                <p class="text-sm font-medium text-red-500">No Car Assigned</p>
                            @endif
                        </div>
                    </div>
                    <div class="col-span-2 flex items-center justify-center">
                        <p class="text-sm font-medium text-black dark:text-white text-center">
                            {{ $loan->user->fullname }}
                        </p>
                    </div>
                    <div class="col-span-2 flex items-center justify-center ">
                    ...
                    <div class="col-span-1 flex items-center justify-center">
                        <p class="text-sm font-medium text-black dark:text-white">
                            Rp {{ number_format($loan->total_cost, 0, ',', '.') }}
                        </p>
                    </div>
                    <div class="col-span-1 flex items-center justify-center">
                        <p class="text-sm font-medium text-black dark:text-white">
