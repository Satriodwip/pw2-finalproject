    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10 flex justify-center">
        ...
        <div class="w-full max-w-lg">
            ...
            <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <h2 class="text-name-md2 font-bold text-black dark:text-white">
                    Form Data
                </h2>
            </div>
            <!-- Breadcrumb End -->
                ...
                <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                    ...
                    <form enctype="multipart/form-data" action="/cars" method="POST">
                        ...
                        <div class="p-6.5">
                            ...
                            <div class="mb-6">
                                <label class="mb-3 block text-sm font-medium text-black dark:text-white"> Cost Per Day <span class="text-meta-1">*</span> </label>
                                <input
                                    id="cost_per_day"
                                    name="cost_per_day"
                                    type="text"
